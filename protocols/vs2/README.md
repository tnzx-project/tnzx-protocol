...
| Feature | VS1 | VS2 |
|---------|-----|-----|
| Download channel | PNG LSB (45 KB/s) | PNG LSB (45 KB/s) *(specified; reference implementation pending)* |
...
Miner Client
    ...
    │                              ↓
    ├──── HTTPS :443 ◄──── Pool (PNG charts + hidden response) [specified; impl pending]
    │

...
Falo is a coordination system for human groups that guarantees participant anonymity, censorship resistance, and protection against infiltration and betrayal. Unlike existing systems that protect only communication content, Falo protects the existence of the group itself, the identity of its members, and the organizational structure.
...
Layer 2: Encryption      (AES-256-GCM, X25519, HKDF)
